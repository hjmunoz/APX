...
public class MockBundleContext implements BundleContext,
	...
	public Bundle getBundle() {
		...
		Mockito.when(mockBundle.getSymbolicName()).thenReturn("WIKJR002IMPL-0.0.0");
		Mockito.when(mockBundle.getVersion()).thenReturn(new Version("0.0.0"));
		return mockBundle;
	}
