...
/**
 * Test for transaction WIKJT00201COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT00201COTest.xml" })
public class WIKJT00201COTransactionTest {

	@Autowired
	private WIKJT00201COTransaction transaction;
